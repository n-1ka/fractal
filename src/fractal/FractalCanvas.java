...
public class FractalCanvas extends Canvas implements Zoomable {
	...
	public FractalCanvas(Mfloat x, Mfloat y, Mfloat viewSize,
	...
	public FractalCanvas(int pixelSize, FractalEvaluator evaluator) {
